...
public class IdPass extends javax.swing.JFrame {

    /**
     * Creates new form IdPass
     */
    public IdPass() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("This field requires Id and Password");

        jLabel4.setFont(new java.awt.Font("Dialog", 3, 12)); // NOI18N
        jLabel4.setText("Please enter valid Id and Password");

        jLabel5.setFont(new java.awt.Font("Dialog", 3, 11)); // NOI18N
        jLabel5.setText("Only admins are allowed in this field");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(user.contains("safwan") && pass.contains("szabist123")){
            Admin a= new Admin();
            a.setVisible(true);
            setVisible(false);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IdPass.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
